...
* prikupljeni trebaju da budu **nezavisni**
...
Sume kvadrata rastu sa porastom broja uzorka (nagomilava se), pa zbog toga moramo delimo sa 
**brojem stepeni slobode (degrees of freedom)**. To je broj elemenata u uzorku.

Ako je podelimo sa njenim stepenom slobode dobijamo korigovanu uzoracku disperziju.

Stepeni slobode za:
* ukupnu (totalnu) suma kvadrata: $d_{f_{tot}}=n-1$
...
Deo $\sim F_{k-1, n-k}$ znaci da `F` ima raspodelu $F_{k-1, n-k}$. [Link do tabela](slike/f-raspodela/).
...
* [Kruskal Wallis H Test: Definition, Examples, Assumptions, SPSS](https://www.statisticshowto.com/probability-and-statistics/statistics-definitions/kruskal-wallis/)
